...
public:
	...
	void setOrigin(string origni);					//Sets the name of the object that generated the bullet
	string getOrigin();								//Gets the name of the object that generated the bullet
};
#endif